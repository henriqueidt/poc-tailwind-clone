...
const defaultHtmlUrl = "index.html";
const defaultCssUrl = "styles.css";
...
const readHtml = async (filename: string, cssUrl: string) => {
...
export const init = (htmlUrl: string, cssUrl: string) => {
  const app = express();
